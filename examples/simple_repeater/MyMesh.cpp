...
#endif
{
  ...
  _prefs.mqtt_autostart = 1;    // connect to MQTT broker on boot (old prefs files keep this default)
...
#if defined(WITH_MQTT_BRIDGE)
  bridge.begin();  // bridge.mqtt_autostart governs whether it connects immediately
#else
