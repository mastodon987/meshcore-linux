...
void CommonCLI::loadPrefsInt(FILESYSTEM* fs, const char* filename) {
  ...
  if (file) {
    ...
    // 293
    file.read((uint8_t *)_prefs->mqtt_server, sizeof(_prefs->mqtt_server));        // 293
    file.read((uint8_t *)&_prefs->mqtt_port, sizeof(_prefs->mqtt_port));           // 421
    file.read((uint8_t *)_prefs->mqtt_topic, sizeof(_prefs->mqtt_topic));          // 423
    file.read((uint8_t *)_prefs->mqtt_user, sizeof(_prefs->mqtt_user));            // 456
    file.read((uint8_t *)_prefs->mqtt_pass, sizeof(_prefs->mqtt_pass));            // 489
    file.read((uint8_t *)&_prefs->mqtt_autostart, sizeof(_prefs->mqtt_autostart)); // 522
    file.read((uint8_t *)&_prefs->mqtt_banned, sizeof(_prefs->mqtt_banned));       // 523
    // 524
...
void CommonCLI::savePrefs(FILESYSTEM* fs) {
  ...
  if (file) {
    ...
    // 293
    file.write((uint8_t *)_prefs->mqtt_server, sizeof(_prefs->mqtt_server));        // 293
    file.write((uint8_t *)&_prefs->mqtt_port, sizeof(_prefs->mqtt_port));           // 421
    file.write((uint8_t *)_prefs->mqtt_topic, sizeof(_prefs->mqtt_topic));          // 423
    file.write((uint8_t *)_prefs->mqtt_user, sizeof(_prefs->mqtt_user));            // 456
    file.write((uint8_t *)_prefs->mqtt_pass, sizeof(_prefs->mqtt_pass));            // 489
    file.write((uint8_t *)&_prefs->mqtt_autostart, sizeof(_prefs->mqtt_autostart)); // 522
    file.write((uint8_t *)&_prefs->mqtt_banned, sizeof(_prefs->mqtt_banned));       // 523
    // 524
